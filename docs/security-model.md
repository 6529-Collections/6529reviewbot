...
Scheduled alert payloads are sanitized at the notifier boundary before stdout,
webhook, or SNS delivery so secret-shaped scope values, titles, messages, job
ids, or custom keys do not leave the bot unchanged.
