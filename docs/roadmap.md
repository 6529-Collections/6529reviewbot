...
- public-governance checks for MIT license metadata, community files, issue
  templates, issue-template safety prompts, and README governance links;
...
- operator drill command that rehearses release-candidate, dogfood readiness,
  production deployment, dashboard deployment, alert delivery, promotion, and
  go-live summaries against a temporary or private workspace before an
  operator runs the final ready gates.
...
- operator drill command and contract check for public-safe release-candidate,
  ...
  delivery, promotion, and go-live rehearsals.
...
- operator drill contract for release-candidate, dogfood readiness, production
  deployment, dashboard deployment, alert delivery, and go-live rehearsal
  behavior.
