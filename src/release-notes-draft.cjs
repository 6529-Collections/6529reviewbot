...
function formatReleaseNotesMarkdown(draft) {
  const lines = [
    ...
    `- \`npm --silent run dogfood:promotion -- -- --operator-workspace <private-workspace-dir> --strict-preflight --require-ready\`: ${TODO}`,
    `- \`npm --silent run dogfood:go-live -- -- --operator-workspace <private-workspace-dir> --strict-preflight --require-ready\`: ${TODO}`,
