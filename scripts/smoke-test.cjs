...
assert.equal(productionCutoverSummary.pending, 27);
assert.match(
...
assert.equal(candidateBundleWithCutover.readiness.productionCutover.pending, 27);
...
assert.equal(candidateBundleFromWorkspace.readiness.productionCutover.pending, 31);
