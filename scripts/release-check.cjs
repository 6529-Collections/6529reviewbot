...
runNode("scripts/check-codeowners-contract.cjs");
runNode("scripts/check-community-release-gates-contract.cjs");
...
runNode("scripts/check-container-publish-plan-contract.cjs");
