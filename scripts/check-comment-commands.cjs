...
const requiredCommandCases = [
  ...
  { command: "/6529bot deploy-actions", reviewKinds: ["deploy-actions"] },
  { command: "/6529bot review deploy-actions", reviewKinds: ["deploy-actions"] },
  { command: "/6529bot auth-api", reviewKinds: ["auth-api"] },
  { command: "/6529bot review auth-api", reviewKinds: ["auth-api"] },
  { command: "/6529bot db-lambda", reviewKinds: ["db-lambda"] },
  ...
  { command: "/6529bot review release-deploy", reviewKinds: ["release-deploy"] },
  { command: "/6529bot privacy-evidence", reviewKinds: ["privacy-evidence"] },
  { command: "/6529bot review privacy-evidence", reviewKinds: ["privacy-evidence"] },
  { command: "/6529bot signer-ux", reviewKinds: ["signer-ux"] },
  { command: "/6529bot review signer-ux", reviewKinds: ["signer-ux"] },
  { command: "/6529bot glm-swarm", reviewKinds: ["glm-swarm"] },
  { command: "/6529bot review glm-swarm", reviewKinds: ["glm-swarm"] },
